...
def get_structured_content_request_body(sphinx_article: dict):
    ...
    structured_content_request_body = {
        ...
        "contentFields": [
            ...
            {
                "contentFieldValue": {"data": ""},
                "contentFieldValue_i18n": {DEFAULT_LANGUAGE_ID: {"data": ""}},
                "name": "githubEditLink",
            },
        ],
...
def import_structured_contents(
    ...
    for sphinx_article in sphinx_articles:
        (
            structured_content_request_body,
            sha_256sum,
        ) = get_structured_content_request_body(sphinx_article)
